...
export default function DiscountsPage() {
  ...
  const headers = ['№', "O'quvchi", 'Kurs', 'Kurs narxi', 'Chegirma %', 'Muddat', 'Holat', 'Amallar'];
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            {loading
              ...
              : discounts.length === 0
                ? <tr><td colSpan={8} className="px-4 py-16 text-center text-gray-400">Chegirmalar mavjud emas</td></tr>
                : discounts.map((d, idx) => {
